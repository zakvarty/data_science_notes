...
#> # A tibble: 6 × 11
#>   observation…¹   V1_A     V2_B   V3_C    V4_D    V5_E    V6_F    V7_G   V8_H
#>           <int>  <dbl>    <dbl>  <dbl>   <dbl>   <dbl>   <dbl>   <dbl>  <dbl>
#> 1             1  1.01   0.359    0.639  0.0725  0.0580 -0.697   0.216   0.637
#> 2             2 -0.651 -1.44    -1.59   0.339  -1.32    0.142  -0.233  -0.188
#> 3             3  0.199 -0.00296 -0.756  0.911   2.89   -1.29    1.03   -0.378
#> 4             4  2.62   1.05     0.528 -0.531  -0.447   0.0561 -1.75   -0.364
#> 5             5 -2.09   0.896    0.267 -0.453   0.278  -0.968   0.118  -0.313
#> 6             6  0.667 -0.314   -0.124 -0.608   1.12   -0.0626 -0.0380 -1.71 
#> # … with 2 more variables: V9_I <dbl>, V10_J <dbl>, and abbreviated variable
#> #   name ¹​observation_id
```
